...
export function ProductSelector({ products, value, onChange, placeholder = "Seleccionar producto..." }: ProductSelectorProps) {
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            >
                {selectedProduct ? (
                    <span className="truncate">{selectedProduct.name} (Stock: {selectedProduct.stock})</span>
                ) : (
                        ...
                        filteredProducts.map((product) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    value === product.id ? "bg-slate-50 font-medium" : ""
                                )}
                                onClick={() => {
                                    onChange(product.id);
                                    setOpen(false);
